...
export const teamProject = {
  ...
  sponsor: { name: 'North Central HS', verified: true, since: 'since 1962', contact: 'Ms. Alvarez', roomBookedTo: '—', insurance: 'On file', slug: 'vu-school', lastReview: 'Aug 1', rating: 'Strong', renewal: 'Recommended' },
...
export const teamPeople = [
  { id: 'tm-nora', n: 'Nora Beckett', short: 'Nora B.', s: 'North Central HS · Grade 12', school: 'North Central HS', grade: 12, role: 'Lead organizer', teamRoleId: TB_ORG, positionId: null, st: 'Active', hrs: 6.5, last: 'Today', tags: ['Founder'], slug: 'p-nora', consent: true, trained: true, briefingAck: { [TB_ORG]: true }, notes: [] },
  { id: 'tm-isaac', n: 'Isaac Flores', short: 'Isaac F.', s: 'North Central HS · Grade 11', school: 'North Central HS', grade: 11, role: 'Outreach', teamRoleId: TB_OUT, positionId: null, st: 'Active', hrs: 3.0, last: 'Yesterday', tags: [], slug: 'p-isaac', consent: true, trained: false, briefingAck: { [TB_OUT]: true }, notes: [] },
  { id: 'tm-priya', n: 'Priya Nair', short: 'Priya N.', s: 'North Central HS · Grade 10', school: 'North Central HS', grade: 10, role: 'Design', teamRoleId: TB_DES, positionId: null, st: 'Onboarding', hrs: 0, last: '2 days ago', tags: ['New'], slug: 'p-priya', consent: false, trained: false, briefingAck: {}, notes: [] },
];
...
export const teamThreads = [
  { id: 'tt1', n: 'Team channel', p: 'Posters draft is up for a look.', when: '1h', unread: 0, members: 3, repliesOff: false, messages: [
    { id: 'tm1', body: 'Goal doc is done — $4,000 across the three schools. Check the drive.', who: 'Nora Beckett', when: 'Mon' },
    { id: 'tm2', body: 'Outreach template drafted, sending to Nora for a check first.', who: 'Isaac Flores', when: 'Tue' },
  ] },
];

export const teamActivity = [
  { id: 'tac1', t: 'Nora moved "Set up the donation tracker" to Done', w: '2h' },
...
export const teamAudit = [
  { id: 'tau1', t: 'Project created', who: 'Nora B.', w: 'Aug 1' },
  { id: 'tau2', t: 'Role created: Outreach', who: 'Nora B.', w: 'Aug 1' },
];
  ...
  return {
    ...
    projects: [
      ...
      },
      {
        ...teamProject,
        tasks: [
          { id: 'ttk1', t: 'Hit $4,000 across the three schools', done: false },
          { id: 'ttk2', t: 'Bring the team to five members', done: false },
          { id: 'ttk3', t: 'Publish the drive poster', done: false },
        ],
        positions: [],
        sessions: [],
        people: teamPeople.map((x) => ({ ...x })),
        applications: [],
        attendanceSessions: [],
        attendance: {},
        hoursQueue: [],
        ...
        incidents: [],
        disputes: [],
        auditLog: teamAudit.map((x) => ({ ...x })),
        activity: teamActivity.map((x) => ({ ...x })),
        threads: teamThreads.map((x) => ({ ...x })),
        settings: teamSettings.map((x) => ({ ...x })),
        archived: false,
      },
    ],
