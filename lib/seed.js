...
export const teamThreads = [
  { id: 'tt1', n: 'Team channel', p: 'Posters draft is up for a look.', when: '1h', unread: 0, members: 3, repliesOff: false, messages: [
    ...
    { id: 'tm2', body: 'Outreach template drafted, sending to Fairview for a check first.', who: 'John Example', when: 'Tue' },
  ] },
];
...
export const crmPeople = [
  ...
  { id: 'per-sofia', n: 'Jamie Smith', short: 'Jane Roe', s: 'Millbrook HS · Grade 10', school: 'Millbrook HS', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 9.0, last: 'Jul 25', tags: ['Spanish'], slug: 'p-sofia', consent: true, trained: true, notes: [] },
