...
export const proofCards = [
  { quote: '“I needed 40 service hours and had no idea where to start. Had my first shift booked in ten minutes.”', who: 'A student volunteer · Grade 11', slot: 'proof1' },
  { quote: '“The verified hours page went straight into my scholarship application. No chasing signatures.”', who: 'A student volunteer · Grade 12', slot: 'proof2' },
  ...
  { quote: '“Started my own tutoring project through Lead. Nine friends signed up.”', who: 'A student volunteer · Grade 10', slot: 'proof4' },
];
...
export const teamPeople = [
  { id: 'tm-nora', n: 'Fairview Beckett', short: 'A volunteer', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Lead organizer', teamRoleId: TB_ORG, positionId: null, st: 'Active', hrs: 6.5, last: 'Today', tags: ['Founder'], slug: 'p-nora', consent: true, trained: true, briefingAck: { [TB_ORG]: true }, notes: [] },
  { id: 'tm-isaac', n: 'Volunteer 7', short: 'Volunteer 7', s: 'Riverside High · Grade 11', school: 'Riverside High', grade: 11, role: 'Outreach', teamRoleId: TB_OUT, positionId: null, st: 'Active', hrs: 3.0, last: 'Yesterday', tags: [], slug: 'p-isaac', consent: true, trained: false, briefingAck: { [TB_OUT]: true }, notes: [] },
  { id: 'tm-priya', n: 'Volunteer 2', short: 'Volunteer 2', s: 'Riverside High · Grade 10', school: 'Riverside High', grade: 10, role: 'Design', teamRoleId: TB_DES, positionId: null, st: 'Onboarding', hrs: 0, last: '2 days ago', tags: ['New'], slug: 'p-priya', consent: false, trained: false, briefingAck: {}, notes: [] },
];
...
export const teamThreads = [
  { id: 'tt1', n: 'Team channel', p: 'Posters draft is up for a look.', when: '1h', unread: 0, members: 3, repliesOff: false, messages: [
    ...
    { id: 'tm2', body: 'Outreach template drafted, sending to Fairview for a check first.', who: 'Volunteer 7', when: 'Tue' },
  ] },
];
...
export const crmPeople = [
  { id: 'per-maya', n: 'Volunteer 10', short: 'Volunteer 10', s: 'Riverside High · Grade 11', school: 'Riverside High', grade: 11, role: 'Supply lead', positionId: 'pos-supply', st: 'Active', hrs: 14.0, last: 'Jul 27', tags: ['Reliable', 'Driver'], slug: 'p-maya', consent: true, trained: true, notes: [] },
  { id: 'per-deven', n: 'Volunteer 14', short: 'Volunteer 14', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Check-in', positionId: 'pos-checkin', st: 'Active', hrs: 11.5, last: 'Jul 26', tags: ['Trained'], slug: 'p-deven', consent: true, trained: true, notes: [] },
  { id: 'per-sofia', n: 'Volunteer 17', short: 'Volunteer 12', s: 'Millbrook HS · Grade 10', school: 'Millbrook HS', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 9.0, last: 'Jul 25', tags: ['Spanish'], slug: 'p-sofia', consent: true, trained: true, notes: [] },
  { id: 'per-jonah', n: 'Volunteer 8', short: 'Volunteer 8', s: 'Riverside High · Grade 11', school: 'Riverside High', grade: 11, role: 'Tutor', positionId: 'pos-tutor', st: 'Onboarding', hrs: 0.0, last: 'Jul 24', tags: ['Consent sent'], slug: 'p-jonah', consent: true, trained: false, notes: [] },
  { id: 'per-amara', n: 'Volunteer 1', short: 'Volunteer 1', s: 'Northgate North HS · Grade 9', school: 'Northgate North HS', grade: 9, role: 'Photos', positionId: 'pos-photo', st: 'Invited', hrs: 0.0, last: 'Jul 22', tags: ['Under 16'], slug: 'p-amara', consent: false, trained: false, notes: [] },
  { id: 'per-iris', n: 'Volunteer 6', short: 'Volunteer 6', s: 'Millbrook HS · Grade 12', school: 'Millbrook HS', grade: 12, role: 'Tutor', positionId: 'pos-tutor', st: 'Waitlist', hrs: 0.0, last: 'Jul 21', tags: ['Sundays only'], slug: 'p-iris', consent: true, trained: false, notes: [] },
  { id: 'per-theo', n: 'Volunteer 18', short: 'Volunteer 18', s: 'Riverside High · Grade 10', school: 'Riverside High', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 6.0, last: 'Jul 20', tags: ['Math'], slug: 'p-theo', consent: true, trained: true, notes: [] },
  { id: 'per-nina', n: 'Volunteer 11', short: 'Volunteer 11', s: 'Northgate North HS · Grade 11', school: 'Northgate North HS', grade: 11, role: 'Snacks', positionId: 'pos-snack', st: 'Inactive', hrs: 3.0, last: 'Jun 14', tags: ['Follow up'], slug: 'p-nina', consent: true, trained: true, notes: [] },
  { id: 'per-ruth', n: 'Volunteer 15', short: 'Volunteer 15', s: 'Millbrook HS · Grade 11', school: 'Millbrook HS', grade: 11, role: 'Snacks', positionId: 'pos-snack', st: 'Active', hrs: 4.5, last: 'Jul 19', tags: ['Allergy list'], slug: 'p-ruth', consent: true, trained: true, notes: [] },
  { id: 'per-sam', n: 'Volunteer 16', short: 'Volunteer 16', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 5.5, last: 'Jul 26', tags: ['Reliable'], slug: 'p-sam', consent: true, trained: true, notes: [] },
  { id: 'per-lena', n: 'Volunteer 9', short: 'Volunteer 9', s: 'Northgate North HS · Grade 10', school: 'Northgate North HS', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Waitlist', hrs: 0.0, last: 'Jul 18', tags: ['Mornings only'], slug: 'p-lena', consent: false, trained: false, notes: [] },
  { id: 'per-omar', n: 'Volunteer 13', short: 'Volunteer 13', s: 'Riverside High · Grade 9', school: 'Riverside High', grade: 9, role: 'Tutor', positionId: 'pos-tutor', st: 'Onboarding', hrs: 0.0, last: 'Jul 17', tags: ['Under 16'], slug: 'p-omar', consent: false, trained: false, notes: [] },
  { id: 'per-cleo', n: 'Volunteer 5', short: 'Volunteer 5', s: 'Millbrook HS · Grade 11', school: 'Millbrook HS', grade: 11, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 5.0, last: 'Jul 26', tags: ['Reliable'], slug: 'p-cleo', consent: true, trained: true, notes: [] },
  { id: 'per-wes', n: 'Volunteer 20', short: 'Volunteer 20', s: 'Riverside High · Grade 10', school: 'Riverside High', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Waitlist', hrs: 0.0, last: 'Jul 15', tags: ['Sundays only'], slug: 'p-wes', consent: true, trained: false, notes: [] },
];

export const projectApplications = [
  { id: 'app-priya', n: 'Volunteer 2', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Tutor', positionId: 'pos-tutor', when: '2 hours ago', ts: 2, note: 'Tutored at a summer camp. Free every Saturday until November.', slug: 'a-priya', flags: ['Consent on file', 'Trained elsewhere'], status: 'pending', answers: ['I loved the camp I helped at and want to keep going.', 'Every Saturday until November.', 'Two summers of camp tutoring.'] },
  { id: 'app-marcus', n: 'Volunteer 19', s: 'Millbrook HS · Grade 11', school: 'Millbrook HS', grade: 11, role: 'Tutor', positionId: 'pos-tutor', when: 'Yesterday', ts: 26, note: 'Wants hours for the civic scholarship. Can bring two friends.', slug: 'a-marcus', flags: ['Needs training'], status: 'pending', answers: ['I need hours for the civic scholarship and I like this one.', 'Most Saturdays, not Aug 23.', 'No, but I coach my little brother.'] },
  { id: 'app-ava', n: 'Volunteer 3', s: 'Northgate North HS · Grade 10', school: 'Northgate North HS', grade: 10, role: 'Photographer', positionId: 'pos-photo', when: 'Yesterday', ts: 30, note: 'Runs the yearbook camera team.', slug: 'a-ava', flags: ['Media release pending'], status: 'pending', answers: ['I want portfolio work that means something.', 'One Saturday a month.', 'Not with kids, but I shoot the yearbook.'] },
  { id: 'app-ben', n: 'Volunteer 4', s: 'Riverside High · Grade 9', school: 'Riverside High', grade: 9, role: 'Tutor', positionId: 'pos-tutor', when: '2 days ago', ts: 50, note: 'First time volunteering. Asked about a ride from school.', slug: 'a-ben', flags: ['Under 15', 'Transport needed'], status: 'pending', answers: ['My sister learned to read here.', 'All of them if I can get a ride.', 'No experience yet.'] },
];
...
export const attendees = [
  { personId: 'per-maya', n: 'Volunteer 10', role: 'Supply lead', slug: 'p-maya', st: 'Present', inOut: '9:52 AM to 12:06 PM', hrs: 2.2, grade: 'Exceptional', note: 'Ran the whole supply table without being asked.' },
  { personId: 'per-deven', n: 'Volunteer 14', role: 'Check-in', slug: 'p-deven', st: 'Present', inOut: '9:48 AM to 12:04 PM', hrs: 2.3, grade: 'Strong', note: 'Check-in desk cleared in ten minutes.' },
  { personId: 'per-sofia', n: 'Volunteer 17', role: 'Tutor', slug: 'p-sofia', st: 'Late', inOut: '10:22 AM to 12:00 PM', hrs: 1.6, grade: 'Strong', note: 'Bus was delayed, texted ahead.' },
  { personId: 'per-theo', n: 'Volunteer 18', role: 'Tutor', slug: 'p-theo', st: 'Present', inOut: '9:58 AM to 12:02 PM', hrs: 2.1, grade: 'Solid', note: 'Good with the younger group.' },
  { personId: 'per-jonah', n: 'Volunteer 8', role: 'Tutor', slug: 'p-jonah', st: 'Absent', inOut: 'No check-in', hrs: 0.0, grade: 'Not scored', note: 'Excused, family trip. Second miss this term.' },
  { personId: 'per-nina', n: 'Volunteer 11', role: 'Snacks', slug: 'p-nina', st: 'Present', inOut: '10:04 AM to 11:30 AM', hrs: 1.4, grade: 'Needs support', note: 'Left early, wants a shorter role next week.' },
];

export const hoursQueue = [
  { id: 'hq1', personId: 'per-maya', n: 'Volunteer 10', d: 'Jul 26 · 10:02 AM - 12:04 PM', hrs: 2.0, src: 'Auto check-in · on site', ok: true, status: 'pending' },
  { id: 'hq2', personId: 'per-deven', n: 'Volunteer 14', d: 'Jul 26 · 9:48 AM - 12:10 PM', hrs: 2.4, src: 'Auto check-in · on site', ok: true, status: 'pending' },
  { id: 'hq3', personId: 'per-sofia', n: 'Volunteer 17', d: 'Jul 26 · 10:15 AM - 11:40 AM', hrs: 1.4, src: 'Manual · left early', ok: false, status: 'pending' },
  { id: 'hq4', personId: 'per-theo', n: 'Volunteer 18', d: 'Jul 19 · 10:00 AM - 12:00 PM', hrs: 2.0, src: 'Auto check-in · on site', ok: true, status: 'pending' },
];

export const reliability = [
  { n: 'Volunteer 10', slug: 'p-maya', show: '100%', late: '0', score: 'Exceptional', trend: 'Steady', bg: '#EAF3EC', color: '#3F6B4E' },
  { n: 'Volunteer 14', slug: 'p-deven', show: '100%', late: '1', score: 'Strong', trend: 'Steady', bg: '#EAF3EC', color: '#3F6B4E' },
  { n: 'Volunteer 17', slug: 'p-sofia', show: '92%', late: '2', score: 'Strong', trend: 'Improving', bg: '#FDF3E7', color: '#8A5A20' },
  { n: 'Volunteer 8', slug: 'p-jonah', show: '67%', late: '0', score: 'Not scored', trend: 'Two misses', bg: '#F5E7E0', color: '#A8482A' },
  { n: 'Volunteer 11', slug: 'p-nina', show: '80%', late: '1', score: 'Needs support', trend: 'Watch', bg: '#FDF3E7', color: '#8A5A20' },
];
...
export const escalations = [
  { id: 'es1', n: 'Volunteer 8', personId: 'per-jonah', step: 'Second miss', action: 'Automatic check-in message sent, lead follow up required', due: 'Today', resolved: false },
  { id: 'es2', n: 'Volunteer 11', personId: 'per-nina', step: 'Early leave', action: 'Offer a shorter role or a different position', due: 'Before Aug 9', resolved: false },
];
...
export const disputes = [
  { id: 'dp1', n: 'Volunteer 17', personId: 'per-sofia', d: 'Jul 19', claim: 'Says she stayed until 12:20, log shows 12:00', st: 'Open', action: 'Compare geofence exit with sponsor sign-out sheet' },
];

export const auditLog = [
  { id: 'au1', t: 'Hours edited for Nina O. from 1.6 to 1.4', who: 'A volunteer', w: 'Jul 19 · reason: left early' },
  { id: 'au2', t: 'Attendance posted to 6 student profiles', who: 'A volunteer', w: 'Jul 19' },
  { id: 'au3', t: 'Score changed for Nina K. from Solid to Strong', who: 'A volunteer', w: 'Jul 19 · reason: covered a second table' },
...
export const threads = [
  ...
  },
  {
    ...
    repliesOff: false,
    messages: [
      { id: 'm1', body: 'Consent form is signed, when do I start?', who: 'them', whoName: 'Volunteer 8', when: 'Jul 26 · 6:12 PM' },
      { id: 'm2', body: 'Also I can do Aug 16 but not Aug 23.', who: 'them', whoName: 'Volunteer 8', when: 'Jul 26 · 6:13 PM' },
    ],
  },
];
