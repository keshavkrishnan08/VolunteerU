...
export const proofCards = [
  { quote: '“I needed 40 service hours and had no idea where to start. Had my first shift booked in ten minutes.”', who: 'Maya R. · Grade 11, Rivertown', slot: 'proof1' },
  { quote: '“The verified hours page went straight into my scholarship application. No chasing signatures.”', who: 'Rowan O. · Grade 12, Columbus', slot: 'proof2' },
  ...
  { quote: '“Started my own tutoring project through Lead. Nine friends signed up.”', who: 'Nina K. · Grade 10, Austin', slot: 'proof4' },
];
...
export const sponsorMatches = [
  { n: 'Rivertown Public Library', m: 'Hosts 6 student projects · 1.1 mi', st: 'Accepted', stBg: '#EAF3EC', stColor: '#3F6B4E', slug: 'sp-library' },
  { n: 'Riverbend Food Bank', m: 'Hosts 12 student projects · 2.4 mi', st: 'Reviewing', stBg: '#FDF3E7', stColor: '#8A5A20', slug: 'sp-gleaners' },
  { n: 'Keep Rivertown Green', m: 'Hosts 4 student projects · 4.6 mi', st: 'Sent', stBg: '#F6F2EE', stColor: '#6B635C', slug: 'sp-kib' },
];
...
export const opportunities = [
  {
    ...
    closesSoon: true,
    homeMeta: 'Riverbend · Sat 1:00 PM · 2.4 mi',
    homeSlot: 'sug1',
  ...
  },
  {
    ...
    homeMeta: 'Rivertown Library · Sat 10:00 AM · 1.1 mi',
    homeSlot: 'sug2',
...
export const peerProjects = [
  { id: 'pp1', t: 'Saturday Reading Circle', lead: 'Led by Milo B. · Grade 11', leadName: 'Milo Bennett', org: 'Rivertown Public Library', cause: 'Education', crewFilled: 9, crewCap: 12, next: 'Sat 10:00 AM · Branch 4', slot: 'pp1', img: PEXELS.reading, role: 'Tutor', cta: 'Open your project', mine: true, projectId: 'proj-reading' },
  { id: 'pp2', t: 'Northside Food Drive', lead: 'Led by Anaya R. · Grade 12', leadName: 'Anaya Rao', org: 'Riverbend Food Bank', cause: 'Food', crewFilled: 14, crewCap: 20, next: 'Aug 6 · school drop-off', slot: 'pp2', img: PEXELS.food, role: 'Collections', cta: 'Request a spot' },
  { id: 'pp3', t: 'Creek Trail Restoration', lead: 'Led by Theo G. · Grade 11', leadName: 'Theo Grant', org: 'Keep Rivertown Green', cause: 'Environment', crewFilled: 6, crewCap: 15, next: 'Sun 9:00 AM · Millbrook', slot: 'pp3', img: PEXELS.trail, role: 'Planting', cta: 'Request a spot' },
  { id: 'pp4', t: 'Senior Tech Help Desk', lead: 'Led by Ava S. · Grade 10', leadName: 'Ava Sorensen', org: 'Fairview Community Center', cause: 'Seniors', crewFilled: 4, crewCap: 8, next: 'Thu 4:00 PM · Fairview', slot: 'pp4', img: PEXELS.seniors, role: 'Coach', cta: 'Request a spot' },
  { id: 'pp5', t: 'Shelter Supply Sort', lead: 'Led by Rowan O. · Grade 12', leadName: 'Rowan Okafor', org: 'Harbor Light Shelter', cause: 'Homelessness', crewFilled: 11, crewCap: 16, next: 'Sat 1:00 PM · downtown', slot: 'pp5', img: PEXELS.shelter, role: 'Sorting', cta: 'Request a spot' },
  { id: 'pp6', t: 'ESL Homework Club', lead: 'Led by Layla K. · Grade 11', leadName: 'Layla Karim', org: 'Northgate Township Schools', cause: 'Education', crewFilled: 5, crewCap: 10, next: 'Tue 4:00 PM · Northgate', slot: 'pp6', img: PEXELS.reading2, role: 'Tutor', cta: 'Request a spot' },
  { id: 'pp7', t: 'Winter Coat Collection', lead: 'Led by Owen P. · Grade 10', leadName: 'Owen Pike', org: 'Harbor Light Shelter', cause: 'Homelessness', crewFilled: 8, crewCap: 18, next: 'Aug 12 · four school sites', slot: 'pp7', img: PEXELS.shelter, role: 'Collections', cta: 'Request a spot' },
  { id: 'pp8', t: 'Shelter Dog Photo Day', lead: 'Led by Kai V. · Grade 12', leadName: 'Kai Vo', org: 'Rivertown Humane Society', cause: 'Animals', crewFilled: 3, crewCap: 6, next: 'Sat 11:00 AM · Main St', slot: 'pp8', img: PEXELS.outdoor, role: 'Photos', cta: 'Request a spot' },
];
...
export const teamProject = {
  ...
  sponsor: { name: 'Riverside High', verified: true, since: 'since 1962', contact: 'Ms. Reyes', roomBookedTo: '-', insurance: 'On file', slug: 'vu-school', lastReview: 'Aug 1', rating: 'Strong', renewal: 'Recommended' },
...
export const teamPeople = [
  { id: 'tm-nora', n: 'Fairview Beckett', short: 'Fairview B.', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Lead organizer', teamRoleId: TB_ORG, positionId: null, st: 'Active', hrs: 6.5, last: 'Today', tags: ['Founder'], slug: 'p-nora', consent: true, trained: true, briefingAck: { [TB_ORG]: true }, notes: [] },
  { id: 'tm-isaac', n: 'Isaac Flores', short: 'Isaac F.', s: 'Riverside High · Grade 11', school: 'Riverside High', grade: 11, role: 'Outreach', teamRoleId: TB_OUT, positionId: null, st: 'Active', hrs: 3.0, last: 'Yesterday', tags: [], slug: 'p-isaac', consent: true, trained: false, briefingAck: { [TB_OUT]: true }, notes: [] },
  { id: 'tm-priya', n: 'Anaya Rao', short: 'Anaya R.', s: 'Riverside High · Grade 10', school: 'Riverside High', grade: 10, role: 'Design', teamRoleId: TB_DES, positionId: null, st: 'Onboarding', hrs: 0, last: '2 days ago', tags: ['New'], slug: 'p-priya', consent: false, trained: false, briefingAck: {}, notes: [] },
];
...
export const teamThreads = [
  { id: 'tt1', n: 'Team channel', p: 'Posters draft is up for a look.', when: '1h', unread: 0, members: 3, repliesOff: false, messages: [
    { id: 'tm1', body: 'Goal doc is done, $4,000 across the three schools. Check the drive.', who: 'Fairview Beckett', when: 'Mon' },
    { id: 'tm2', body: 'Outreach template drafted, sending to Fairview for a check first.', who: 'Isaac Flores', when: 'Tue' },
  ] },
];

export const teamActivity = [
  { id: 'tac1', t: 'Fairview moved "Set up the donation tracker" to Done', w: '2h' },
  { id: 'tac2', t: 'Isaac started "Personalize the outreach template"', w: '5h' },
  { id: 'tac3', t: 'Priya joined as Design', w: '2d' },
];

export const teamAudit = [
  { id: 'tau1', t: 'Project created', who: 'Fairview B.', w: 'Aug 1' },
  { id: 'tau2', t: 'Role created: Outreach', who: 'Fairview B.', w: 'Aug 1' },
];
...
export const crmPeople = [
  { id: 'per-maya', n: 'Maya Rodriguez', short: 'Maya R.', s: 'Riverside High · Grade 11', school: 'Riverside High', grade: 11, role: 'Supply lead', positionId: 'pos-supply', st: 'Active', hrs: 14.0, last: 'Jul 27', tags: ['Reliable', 'Driver'], slug: 'p-maya', consent: true, trained: true, notes: [] },
  { id: 'per-deven', n: 'Rowan Okafor', short: 'Rowan O.', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Check-in', positionId: 'pos-checkin', st: 'Active', hrs: 11.5, last: 'Jul 26', tags: ['Trained'], slug: 'p-deven', consent: true, trained: true, notes: [] },
  { id: 'per-sofia', n: 'Sofia Kaur', short: 'Nina K.', s: 'Millbrook HS · Grade 10', school: 'Millbrook HS', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 9.0, last: 'Jul 25', tags: ['Spanish'], slug: 'p-sofia', consent: true, trained: true, notes: [] },
  { id: 'per-jonah', n: 'Jonah Park', short: 'Jonah P.', s: 'Riverside High · Grade 11', school: 'Riverside High', grade: 11, role: 'Tutor', positionId: 'pos-tutor', st: 'Onboarding', hrs: 0.0, last: 'Jul 24', tags: ['Consent sent'], slug: 'p-jonah', consent: true, trained: false, notes: [] },
  { id: 'per-amara', n: 'Amara Tesfaye', short: 'Amara T.', s: 'Northgate North HS · Grade 9', school: 'Northgate North HS', grade: 9, role: 'Photos', positionId: 'pos-photo', st: 'Invited', hrs: 0.0, last: 'Jul 22', tags: ['Under 16'], slug: 'p-amara', consent: false, trained: false, notes: [] },
  { id: 'per-iris', n: 'Iris Bennett', short: 'Iris B.', s: 'Millbrook HS · Grade 12', school: 'Millbrook HS', grade: 12, role: 'Tutor', positionId: 'pos-tutor', st: 'Waitlist', hrs: 0.0, last: 'Jul 21', tags: ['Sundays only'], slug: 'p-iris', consent: true, trained: false, notes: [] },
  { id: 'per-theo', n: 'Theo Marsh', short: 'Theo M.', s: 'Riverside High · Grade 10', school: 'Riverside High', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 6.0, last: 'Jul 20', tags: ['Math'], slug: 'p-theo', consent: true, trained: true, notes: [] },
  { id: 'per-nina', n: 'Nina Oyelaran', short: 'Nina O.', s: 'Northgate North HS · Grade 11', school: 'Northgate North HS', grade: 11, role: 'Snacks', positionId: 'pos-snack', st: 'Inactive', hrs: 3.0, last: 'Jun 14', tags: ['Follow up'], slug: 'p-nina', consent: true, trained: true, notes: [] },
  { id: 'per-ruth', n: 'Ruth Delgado', short: 'Ruth D.', s: 'Millbrook HS · Grade 11', school: 'Millbrook HS', grade: 11, role: 'Snacks', positionId: 'pos-snack', st: 'Active', hrs: 4.5, last: 'Jul 19', tags: ['Allergy list'], slug: 'p-ruth', consent: true, trained: true, notes: [] },
  { id: 'per-sam', n: 'Sam Whitaker', short: 'Sam W.', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 5.5, last: 'Jul 26', tags: ['Reliable'], slug: 'p-sam', consent: true, trained: true, notes: [] },
  { id: 'per-lena', n: 'Lena Hoffmann', short: 'Lena H.', s: 'Northgate North HS · Grade 10', school: 'Northgate North HS', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Waitlist', hrs: 0.0, last: 'Jul 18', tags: ['Mornings only'], slug: 'p-lena', consent: false, trained: false, notes: [] },
  { id: 'per-omar', n: 'Omar Haddad', short: 'Omar H.', s: 'Riverside High · Grade 9', school: 'Riverside High', grade: 9, role: 'Tutor', positionId: 'pos-tutor', st: 'Onboarding', hrs: 0.0, last: 'Jul 17', tags: ['Under 16'], slug: 'p-omar', consent: false, trained: false, notes: [] },
  { id: 'per-cleo', n: 'Cleo Barnes', short: 'Cleo B.', s: 'Millbrook HS · Grade 11', school: 'Millbrook HS', grade: 11, role: 'Tutor', positionId: 'pos-tutor', st: 'Active', hrs: 5.0, last: 'Jul 26', tags: ['Reliable'], slug: 'p-cleo', consent: true, trained: true, notes: [] },
  { id: 'per-wes', n: 'Wes Nakamura', short: 'Wes N.', s: 'Riverside High · Grade 10', school: 'Riverside High', grade: 10, role: 'Tutor', positionId: 'pos-tutor', st: 'Waitlist', hrs: 0.0, last: 'Jul 15', tags: ['Sundays only'], slug: 'p-wes', consent: true, trained: false, notes: [] },
];

export const projectApplications = [
  { id: 'app-priya', n: 'Anaya Rao', s: 'Riverside High · Grade 12', school: 'Riverside High', grade: 12, role: 'Tutor', positionId: 'pos-tutor', when: '2 hours ago', ts: 2, note: 'Tutored at a summer camp. Free every Saturday until November.', slug: 'a-priya', flags: ['Consent on file', 'Trained elsewhere'], status: 'pending', answers: ['I loved the camp I helped at and want to keep going.', 'Every Saturday until November.', 'Two summers of camp tutoring.'] },
  { id: 'app-marcus', n: 'Theo Grant', s: 'Millbrook HS · Grade 11', school: 'Millbrook HS', grade: 11, role: 'Tutor', positionId: 'pos-tutor', when: 'Yesterday', ts: 26, note: 'Wants hours for the civic scholarship. Can bring two friends.', slug: 'a-marcus', flags: ['Needs training'], status: 'pending', answers: ['I need hours for the civic scholarship and I like this one.', 'Most Saturdays, not Aug 23.', 'No, but I coach my little brother.'] },
  { id: 'app-ava', n: 'Ava Sorensen', s: 'Northgate North HS · Grade 10', school: 'Northgate North HS', grade: 10, role: 'Photographer', positionId: 'pos-photo', when: 'Yesterday', ts: 30, note: 'Runs the yearbook camera team.', slug: 'a-ava', flags: ['Media release pending'], status: 'pending', answers: ['I want portfolio work that means something.', 'One Saturday a month.', 'Not with kids, but I shoot the yearbook.'] },
  { id: 'app-ben', n: 'Ben Ortiz', s: 'Riverside High · Grade 9', school: 'Riverside High', grade: 9, role: 'Tutor', positionId: 'pos-tutor', when: '2 days ago', ts: 50, note: 'First time volunteering. Asked about a ride from school.', slug: 'a-ben', flags: ['Under 15', 'Transport needed'], status: 'pending', answers: ['My sister learned to read here.', 'All of them if I can get a ride.', 'No experience yet.'] },
];
...
export const attendees = [
  ...
  { personId: 'per-deven', n: 'Rowan Okafor', role: 'Check-in', slug: 'p-deven', st: 'Present', inOut: '9:48 AM to 12:04 PM', hrs: 2.3, grade: 'Strong', note: 'Check-in desk cleared in ten minutes.' },
...
export const hoursQueue = [
  ...
  { id: 'hq2', personId: 'per-deven', n: 'Rowan Okafor', d: 'Jul 26 · 9:48 AM - 12:10 PM', hrs: 2.4, src: 'Auto check-in · on site', ok: true, status: 'pending' },
...
export const reliability = [
  ...
  { n: 'Rowan Okafor', slug: 'p-deven', show: '100%', late: '1', score: 'Strong', trend: 'Steady', bg: '#EAF3EC', color: '#3F6B4E' },
...
export const incidents = [
  ...
  { id: 'in2', d: 'Jul 12', t: 'Room double booked', who: 'Logged by Milo B.', st: 'Closed', note: 'Moved to the annex, sponsor updated the calendar.' },
];
...
export const auditLog = [
  { id: 'au1', t: 'Hours edited for Nina O. from 1.6 to 1.4', who: 'Milo B.', w: 'Jul 19 · reason: left early' },
  { id: 'au2', t: 'Attendance posted to 6 student profiles', who: 'Milo B.', w: 'Jul 19' },
  { id: 'au3', t: 'Score changed for Nina K. from Solid to Strong', who: 'Milo B.', w: 'Jul 19 · reason: covered a second table' },
...
export const activity = [
  { id: 'ac1', t: 'Anaya Rao applied for Tutor', w: '2h' },
  { id: 'ac2', t: 'Rowan Okafor checked out of Aug 2 session', w: '1d' },
...
export const threads = [
  ...
  },
  {
    ...
    repliesOff: false,
    messages: [
      { id: 'm1', body: 'Sent the roster for hour approval. Let me know if the June totals look right.', who: 'them', whoName: 'Ms. Reyes', when: 'Jul 28 · 11:20 AM' },
    ],
  },
  {
    id: 't-branch',
...
export const leadFeedback = [
  { id: 'lf1', who: 'R. Whitfield · Rivertown Public Library', when: 'Jul 26', t: 'Eli set up the room before anyone arrived and ran the tutor briefing himself.', slug: 'fb-whitfield' },
  { id: 'lf2', who: 'D. Cruz · Riverbend Food Bank', when: 'Jul 24', t: 'Carried the line for three hours without a break. Ask him back.', slug: 'fb-cruz' },
];
...
export const notifications = [
  ...
  { id: 'nt2', t: 'Anaya Rao applied for Tutor', b: 'Saturday Reading Circle · review when you can', when: '2h', read: false, tone: 'brand', to: { path: '/lead/proj-reading/applications' } },
